...
export class AddUpdateAgencyRegistrationComponent {
  ...
  defaultForm(data?: any) {
    this.agencyRegisterForm = this.fb.group({
      ...
      "address": [data ? data.address : "", [Validators.required, Validators.maxLength(200)]],
      "agency_Address": [data ? data.agency_Address : "", [Validators.required, Validators.maxLength(200)]],
