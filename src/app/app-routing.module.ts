...
{ path: 'designation-master', loadChildren: () => import('./modules/masters/designation-master/designation-master.module').then(m => m.DesignationMasterModule), canActivate: [], data: { breadcrumb: [{ title: 'Designation Master', active: true }]}},
